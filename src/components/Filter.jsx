...
//       <div className="flex items-center border border-gray-300 p-2 justify-between">
...
//               {openDropdown === option && (
//                 <div className="absolute top-8 left-0 w-80 bg-white p-2 mt-1 shadow-lg border border-gray-300">
//                   <input
//                     type="text"
...
//           ))}
//         </div>
//         <button className="bg-sky-400 cursor-pointer px-4 py-2 font-medium text-white hover:bg-sky-600 uppercase">
//           Apply Filter
//         </button>
//       </div>
//     </section>
